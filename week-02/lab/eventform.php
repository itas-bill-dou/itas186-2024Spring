              ...
              <div class="flex flex-col">
                ...
                <div class="text-sm flex flex-col">
                  <label class="inline-flex items-center mt-3">
                    <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" value="Light Refreshment"><span class="ml-2 text-gray-700">Light Refreshment</span>
                  </label>
                  <label class="inline-flex items-center mt-3">
                    <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" value="Exciting Games"><span class="ml-2 text-gray-700">Exciting Games</span>
                  </label>
                  <label class="inline-flex items-center mt-3">
                    <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" value="Prizes and Giveaways"><span class="ml-2 text-gray-700">Prizes and Giveaways</span>
                  </label>
                  <label class="inline-flex items-center mt-3">
                    <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" value="Goodie Bags"><span class="ml-2 text-gray-700">Goodie Bags</span>
                  </label>
                </div>
              </div>
